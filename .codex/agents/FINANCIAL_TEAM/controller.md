...
team: FINANCIAL_TEAM
source: FINANCIAL_TEAM/.claude/agents/controller.md
...
This file is generated for Codex from `FINANCIAL_TEAM/.claude/agents/controller.md`. Do not edit it by hand;
