...
display_name: investor-relations-agent
team: FINANCIAL_TEAM
source: FINANCIAL_TEAM/.claude/agents/investor-relations-agent.md
...
This file is generated for Codex from `FINANCIAL_TEAM/.claude/agents/investor-relations-agent.md`. Do not edit it by hand;
