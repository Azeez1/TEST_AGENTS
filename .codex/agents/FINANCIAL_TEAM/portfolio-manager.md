...
team: FINANCIAL_TEAM
source: FINANCIAL_TEAM/.claude/agents/portfolio-manager.md
...
This file is generated for Codex from `FINANCIAL_TEAM/.claude/agents/portfolio-manager.md`. Do not edit it by hand;
