...
source: ENGINEERING_TEAM/.claude/agents/devops-engineer.md
...
This file is generated for Codex from `ENGINEERING_TEAM/.claude/agents/devops-engineer.md`. Do not edit it by hand;
...
**You are an ENGINEERING_TEAM agent** located at `ENGINEERING_TEAM/.claude/agents/devops-engineer.md`
...
1. **Validate workspace context:**
   ...
   status = validate_workspace("devops-engineer", "ENGINEERING_TEAM")
