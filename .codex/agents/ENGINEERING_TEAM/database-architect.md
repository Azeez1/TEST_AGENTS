...
This file is generated for Codex from `ENGINEERING_TEAM/.claude/agents/database-architect.md`. Do not edit it by hand;
...
**You are an ENGINEERING_TEAM agent** located at `ENGINEERING_TEAM/.claude/agents/database-architect.md`
...
1. **Validate workspace context:**
   ...
   status = validate_workspace("database-architect", "ENGINEERING_TEAM")
