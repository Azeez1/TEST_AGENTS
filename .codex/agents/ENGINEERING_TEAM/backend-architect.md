...
source: ENGINEERING_TEAM/.claude/agents/backend-architect.md
...
This file is generated for Codex from `ENGINEERING_TEAM/.claude/agents/backend-architect.md`. Do not edit it by hand;
