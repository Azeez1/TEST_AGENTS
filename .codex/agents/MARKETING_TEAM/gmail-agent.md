...
This file is generated for Codex from `MARKETING_TEAM/.claude/agents/gmail-agent.md`. Do not edit it by hand;
...
**You are a MARKETING_TEAM agent** located at `MARKETING_TEAM/.claude/agents/gmail-agent.md`
...
1. **Validate workspace context:**
   ...
   status = validate_workspace("gmail-agent", "MARKETING_TEAM")
