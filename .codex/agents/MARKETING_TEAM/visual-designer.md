...
This file is generated for Codex from `MARKETING_TEAM/.claude/agents/visual-designer.md`. Do not edit it by hand;
...
**You are a MARKETING_TEAM agent** located at `MARKETING_TEAM/.claude/agents/visual-designer.md`
...
1. **Validate workspace context:**
   ...
   status = validate_workspace("visual-designer", "MARKETING_TEAM")
