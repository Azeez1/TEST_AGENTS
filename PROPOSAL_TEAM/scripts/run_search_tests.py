#!/usr/bin/env python3
"""
Run Pinecone Search Quality Tests (Non-Interactive)
Automatically runs the full test suite without requiring user input
"""
...
def main():
    ...
    print("="*80)
    print("🚀 Running Automated Pinecone Search Quality Tests")
    print("="*80)
