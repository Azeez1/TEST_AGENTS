...
**Applies To:** All 73 agents across 8 teams before creating/declaring/using any tool or skill (see [CLAUDE.md](CLAUDE.md) — single source of truth for roster counts)
