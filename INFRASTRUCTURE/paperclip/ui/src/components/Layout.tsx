        ...
        {isMobile ? (
          ...
          >
            <div className="flex flex-1 min-h-0 overflow-hidden">
              {/*
                Re-grafted user customization (phase3b 2026-05-10):
                CompanyRail is a 72px draggable sidebar rail with live-agent + unread-inbox
                badges. Upstream refactored Layout to use plugin route sidebar slots and
                dropped this mount. Re-mounted here as a quick fix.
                TODO: convert to a proper plugin route sidebar slot in a future cleanup so
                this lives outside the Layout component and ships through the plugin system.
              */}
              <CompanyRail />
