...
function generateReadmeFromSelection(
  ...
  lines.push("```");
  lines.push("");
  lines.push("See [Dux Machina OS](https://paperclip.ing) for more information.");
  lines.push("");
  lines.push("---");
  lines.push(`Exported from [Dux Machina OS](https://paperclip.ing) on ${new Date().toISOString().split("T")[0]}`);
  lines.push("");
