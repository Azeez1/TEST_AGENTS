...
This repository contains **6 autonomous AI agent systems** powered by the Claude Agent SDK, featuring **63 specialized agents** for RFP/proposal automation, marketing automation, test generation, software engineering, quality assurance, AI/ML development, financial analysis, and sales operations.
...
- **FINANCIAL_TEAM** (14) - PE/M&A + General Finance (deal analysis, valuations, FP&A, accounting, tax, CFO strategy, treasury, investor relations, trading optimization)
...
**⚡ Key Facts:**
- 63 autonomous agents across 6 systems
...
- [Complete Agent Directory](#-complete-agent-directory) - All 63 agents at a glance
...
├── MULTI_AGENT_GUIDE.md             ← Master guide for all 63 agents
...
│
├── FINANCIAL_TEAM/                  ← 14 agents: PE/M&A + Finance (see README.md)
...
| **FINANCIAL_TEAM** | 14 | PE/M&A + General Finance (deal analysis, valuations, FP&A, accounting, CFO strategy, treasury, investor relations, trading optimization) |
| **SALES_TEAM** | 9 | Full sales lifecycle (SDR, AE, sales ops, proposals, customer success, PE investor outreach) |
| **TOTAL** | **63** | **Complete enterprise AI agent workforce** |
...
**Trading:** trading-optimizer (FINANCIAL) - ICT strategy autoresearch, Pine Script optimization, Chrome MCP backtesting, Funding Pips risk constraints
...
- Detailed capabilities for all 63 agents
...
### Usage Guides
- [MULTI_AGENT_GUIDE.md](MULTI_AGENT_GUIDE.md) - **MASTER GUIDE** for all 63 agents
...
**Comprehensive governance framework** ensures consistent tool/MCP/skill usage across all 63 agents and prevents redundant tool creation.
...
**LLAR (Layered Language Agent Reasoning)** is the meta-governance framework for the 63-agent multi-team system. It formalizes task routing, agent coordination, reflection checks, memory persistence, and conflict resolution.
...
6. **Refer to MULTI_AGENT_GUIDE.md** - Master guide for all 63 agents
...
**All 63 agents automatically know their workspace** - team folder, memory location, output paths, and cross-team boundaries via workspace_enforcer tool.
...
- ✨ **trading-optimizer agent** - 14th FINANCIAL_TEAM agent: ICT strategy autoresearch optimizer with Pine Script parameter tuning, Chrome MCP backtesting, and Funding Pips risk guard rails
- ✨ **63 agents total** - Added trading-optimizer to FINANCIAL_TEAM (14 agents)
...
- ✨ **FINANCIAL_TEAM** (14 agents) - PE/M&A + General Finance (deal-analyst, valuation, FP&A, CFO, accounting, tax, treasury, investor relations, financial data analysis, trading optimization)
